...
UBUNTU_TRANSLATION_DOMAIN="baidumap.liu-xiao-guo"
...
aptest.commands = bash $$PWD/baidumap/tests/autopilot/run
aptest.depends  = sub-baidumap

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/baidumap/tests/unit
unittest.depends  = sub-baidumap
